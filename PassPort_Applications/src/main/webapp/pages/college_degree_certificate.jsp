...
<body >
	...
	<div class="Twelfth-certificate-page">
	  <div class="title">Upload your College Degree certificate</div>
	  <section class="form">
	    <form class="login-form" method="POST" action="/college_degree_certificate" enctype="multipart/form-data">
